...
#
#     PHX_SERVER=true bin/elixir_phoenix_context_blog_post start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :elixir_phoenix_context_blog_post, ElixirPhoenixContextBlogPostWeb.Endpoint, server: true
end
